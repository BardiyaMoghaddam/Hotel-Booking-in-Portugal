#In this analysis I want to find the answer for following questions:
#1-When is the Peak Booking Seasons for these two hotels?
#2-when is the peak dates for these two hotels?
#3-what is the relationship between the number of days from booking to arrival and cancelation?
#4-which countries the guests came from?
#5- what is the Market segment for these two hotels and how they differ?
#6-What is the Average Length of Stay in both hotels?
#7-What are the Most Common Customer Types for both hotels?
#8-What is the Total Number of Guests Per Year for each hotel including adults, children, and babies?
#9-what are the most booked room types in both hotels?
...
#Calculate the Average Lead Time for Cancellations to see what is the relationship between the number of days from booking to arrival and cancelation. 
...
#what are the most booked room types in both hotels?
